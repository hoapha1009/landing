...
export function FeaturesBanner() {
  return (
    <div className="relative mb-32 flex h-[476px] max-h-[476px] w-full flex-row overflow-hidden bg-[url('/images/home-banner.png')] bg-cover  bg-no-repeat lg:h-[725px] lg:max-h-[725px]">
